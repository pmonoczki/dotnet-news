...
var _om_tn_centers = {
biztalk	: "msstotnctbiztalk", dpm	: "msstotnctdpm", desktopdeployment : "msstotnctdeskdep", edge: "msstotnctedge", exchange : "msstotnctexch",
...
scriptcenter : "msstotnctscript", scvmm : "msstotnctscvmm", sharepoint : "msstotnctshare", updatemanagement : "msstotnctupdmg", 
virtualization : "msstotnctvirt", windows : "msstotnctwin", windowsmobile : "msstotnctwinmob", windowsserver : "msstotnctwinserv"
}
// added sharepoint : "msstotnctshare" on 11/16/09
// added scriptcenter : "msstotnctscript" on 11/16/09
// added edge: "msstotnctedge" for 6/29/10

var _om_msdn_centers = {
biztalk :"msstoctbiztalk",netframework :"msstoctnetfx",academic :"msstoctacad",architecture :"msstoctarch",azure :"msstoctazure",
beginner :"msstoctbegin",data :"msstoctdata",devlabs :"msstoctdevlabs",
directx :"msstoctdx",dynamics :"msstoctdynamics",evalcenter :"msstocteval",exchange :"msstoctexch",fsharp :"msstoctfsharp",
...
rampup :"msstoctrampup",robotics :"msstoctrobotics",scriptjunkie : "msstoctscjnkie", security :"msstoctsecurity",sharepoint :"msstoctshare",
...
// added msdn center scriptjunkie for 6/29/10
...
_technet_library_forefront_client_ : "msstotnlib4front", _technet_library_forefront_edge_ : "msstotnlib4front",
_technet_library_forefront_server_ : "msstotnlib4front", _technet_library_forefront_stirling_ : "msstotnlib4front",
scriptcenter_technet : "msstotnctscript", _technet_library_security_ : "msstotnlibsecurity", _technet_solutionaccelerators_ : "msstotnlibsolacc"
}
// added tn lib split param _technet_library_security_ : "msstotnlibsecurity" on 11/16
// added tn split param   scriptcenter_technet : "msstotnctscript" on 11/16
// added _technet_solutionaccelerators_ : "msstotnlibsolacc" on 3/2/10
// removed _technet_library_sqlserver_  : "msstotnlibsql", on 3/2/10
// added back in _technet_library_sqlserver_  : "msstotnlibsql", on 3/24/10

var _om_msdn_split_params = {
 _msdnlib_es_dev_BTS_2009_ : "msstolibbts09",  _msdnlib_es_dev_BTS_2006R2_ : "msstolibbts06r2",
 ...
 msdnlib_office : "msstoliboffice",  _sto_msdn_sql_library : "msstolibsql", _msdn_library_sqlserver_ : "msstolibsql",
...
dech:1,ukua:1,hiin:1,heil:1,arsa:1,ptpt:1,
...
gallery_msdn_microsoft_com:1,innovation_connect_microsoft_com:1
}
...
_om_gbls.addrsid('h','gallery.technet.microsoft.com','msstotn');	
_om_gbls.addrsid('h','gallery.technet.microsoft.com','msstotnonly');	
...
if (_om_gbls.host.indexOf('expression.microsoft.com')>-1) {  
	...
	if (_om_gbls.path.indexOf('library') > -1) _om_gbls.apl(_om_gbls.s_account,"msstoexplib",",",2); 
}
...
_om_gbls.addrsid('f','social.technet.microsoft.com/wiki','msstotnsocwiki');
}
// added 7/10/2009, updated to exclude answers for 6/29/2010
if (_om_gbls.host.indexOf('social') > -1 && _om_gbls.host.indexOf('answers') < 0 && _om_gbls.path.indexOf('/profile') == 0) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account,"msstoprofileroll",",",2); // profile rollup

// added 3/23/2010
_om_gbls.addrsid('f','gallery.msdn.microsoft.com/scriptjunkie/en-us/','msstomsdnscjnkie');

// added 3/23/2010
if(_om_gbls.path.indexOf('/de-de/') > -1 && _om_gbls.host.indexOf('msdn') > -1) {
	_om_gbls.addrsid('f','msdn.microsoft.com/de-de/','msstomsdnmktdederoll');
	_om_gbls.addrsid('f','social.msdn.microsoft.com/forums/de-de/categories','msstomsdnmktdederoll');
	_om_gbls.addrsid('f','social.msdn.microsoft.com/search/de-de/','msstomsdnmktdederoll');
	_om_gbls.addrsid('f','social.msdn.microsoft.com/profile/de-de/','msstomsdnmktdederoll');
	_om_gbls.addrsid('f','visualstudiogallery.msdn.microsoft.com/de-de/','msstomsdnmktdederoll');
}
_om_gbls.addrsid('f','www.microsoft.com/germany/msdn/','msstomsdnmktdederoll');	

if(_om_gbls.path.indexOf('/de-de/') > -1 && _om_gbls.host.indexOf('technet') > -1) {
	_om_gbls.addrsid('f','technet.microsoft.com/de-de/','msstotnmktdederoll');	
	_om_gbls.addrsid('f','social.technet.microsoft.com/forums/de-de/categories','msstotnmktdederoll');
	_om_gbls.addrsid('f','social.technet.microsoft.com/search/de-de/','msstotnmktdederoll');
	_om_gbls.addrsid('f','social.technet.microsoft.com/profile/de-de/','msstotnmktdederoll');
	_om_gbls.addrsid('f','visualstudiogallery.technet.microsoft.com/de-de/','msstotnmktdederoll');
}
_om_gbls.addrsid('f','www.microsoft.com/germany/technet/','msstotnmktdederoll');
...
_om_gbls.addrsid('h','innovation.connect.microsoft.com','msstoinnconn');
// msstoinnconn added 6/29/10
...
switch (_om_gbls.host)
{
	case "msdn.microsoft.com":
		...
		if (_om_gbls.market) { 
			try {
				if (_om_gbls.market.indexOf('es\-') > -1 && _om_gbls.market.indexOf('es\-es') == -1 ) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account,"msstomsdnmktesroll",",",2);
	...
	case "technet.microsoft.com":
		...
		if (_om_gbls.market) { 
			try {
				if (_om_gbls.market.indexOf('es\-') > -1 && _om_gbls.market.indexOf('es\-es') == -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account,"msstotnmktesroll",",",2);
		...
		// ad hoc
		_om_gbls.addrsid('f','technet.microsoft.com/edge/','msstotnedge');  // may not be necessary
...
_om_gbls.addrsid('f','gallery.technet.microsoft.com/scriptcenter','msstotnctscript');	
...
// 7/21/2009
try { if(_om_gbls.getOmniMeta("DCSext.WCversion")) _om_gbls.s_account =_om_gbls.apl(_om_gbls.s_account,"msstotnwcroll",",",2); } catch(e) {}
try { if(_om_gbls.getOmniMeta("DCSext.Care").toLowerCase().indexOf("msdn")>-1) _om_gbls.s_account =_om_gbls.apl(_om_gbls.s_account,"msstomsdncare",",",2); } catch(e) {}
try { if(_om_gbls.getOmniMeta("DCSext.Care").toLowerCase().indexOf("technet")>-1) _om_gbls.s_account =_om_gbls.apl(_om_gbls.s_account,"msstotncare",",",2); } catch(e) {}

// 5/10/10
try { if(_om_gbls.getOmniMeta("t_omni_dpecar")) _om_gbls.s_account =_om_gbls.apl(_om_gbls.s_account,"msstodpecar",",",2); } catch(e) {}
...
if (_om_gbls.offprodfam == "MSDN_OFFICE" && _om_gbls.market == "en-us" && 
	(_om_gbls.center == "office" || _om_gbls.center == "sharepoint" || _om_gbls.center == "vsto")) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account,"msstooffcentenus",",",2);
if (_om_gbls.offprodfam == "MSDN_OFFICE" && _om_gbls.market == "en-us" && _om_gbls.library=="1") _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account,"msstoofflibenus",",",2);
...
if (_om_gbls.extraRsids) {
	...
	for(var i=0;i < _om_gbls.extraRsidsArr.length;i++) {
		_om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account,_om_gbls.extraRsidsArr[i],",",2);
	}
}
...
var t_omni_utils = {
	...
	, omniAddPVEvent : function() {
		 if (!s.linkType) { 
 			 s.eVar21 = "D=pageName";  // changed from 17 to 21 on 3/30/10
	...
	setTrackVars : function() {
		return "eVar20,eVar21,eVar22,eVar23,eVar24,eVar25,eVar26,eVar28,eVar29,eVar35,eVar36,eVar37,events";
	}, 
	...
	videoComplete : function(mediaName) {
		t_omni_utils.videoEvent("event6","Video Complete: ",mediaName);
	...
	omniModTracking : function(obj,mod1,mod2,destURL,type,altText,evts) {
		// Notes:
		// removed sprops
		// switch eVar17 to eVar21?
		// add concatenation variable?
		// update linkTrackVars as appropriate
		...
		if(destURL.indexOf('atdmt.com')>-1) {
			destURL = t_omni_utils.omni_StripQS(destURL);
		}
		s.eVar12=destURL;
		var module=(mod2) ? mod1+"__"+mod2 : mod1;
		s.eVar13=mod1;
		s.eVar14=module;
		s.eVar15=module+": "+destURL;
		s.eVar16=module+": "+altText;
		s.eVar17=s.pageName+": "+s.eVar16;
		s.eVar21=s.pageName;		
		
		// 13:CM1, 14:CM2, 15:CE, 16:HL, 17:Sourcepage
		if(type==0) {
		...
		s.eVar12=s.eVar13=s.eVar14=s.eVar15=s.eVar16=s.eVar17=eVar21=s.events="";
		}
}
...
function s_doPlugins(s) {
	...
	s.prop31=s.getQueryParam('query');
	s.prop32=s.getQueryParam('ac');
	s.prop33=s.getQueryParam('refinement');
	s.prop36=s.getQueryParam('missingurl'); // added 11/16/09
	...
	if (_om_gbls.host=="help.outlook.com") {
		...
		s.prop37=s.getQueryParam('ref'); // added primarily for help.outlook.com but also present on a technet exchange page
		s.prop38=s.getQueryParam('v'); 
		//s.prop37=s.getQueryParam('t'); // need to scope this to just the appropriate EMC page since used there
	}
...
try {
// switched to eVar44 in v1.5 090820
